...
class ComplaintCoreDataTest: XCTestCase {

    typealias AppModelClass = Complaint
    var entityName: String { return Complaint.entityName }
    var sut: AppModelClass { return ComplaintEndpointTest.objectA }
