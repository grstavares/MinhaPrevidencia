...
class DocumentCoreDataTest: XCTestCase {

    typealias AppModelClass = Document
    var entityName: String { return Document.entityName }
    var sut: AppModelClass { return DocumentEndpointTest.objectA }
