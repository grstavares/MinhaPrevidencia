...
class UserProfileCoreDataTest: XCTestCase {

    typealias AppModelClass = UserProfile
    var entityName: String { return UserProfile.entityName }
    var sut: AppModelClass { return UserProfileEndpointTest.objectA }
