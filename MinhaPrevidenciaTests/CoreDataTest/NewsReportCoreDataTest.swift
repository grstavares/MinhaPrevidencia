...
class NewsReportCoreDataTest: XCTestCase {

    typealias AppModelClass = NewsReport
    var entityName: String { return NewsReport.entityName }
    var sut: AppModelClass { return NewsReportEndpointTest.objectA }
