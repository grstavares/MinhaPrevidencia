...
class AddressCoreDataTest: XCTestCase {

    typealias AppModelClass = Address
    var entityName: String { return Address.entityName }
    var sut: AppModelClass { return Address.init(uuid: "uuid", country: "country", region: "region", city: "city", postalCode: "post", streetAddress: "str", streetNumber: "nbr", buildName: "buil", unitNumber: nil, location: nil, isMain: false) }
