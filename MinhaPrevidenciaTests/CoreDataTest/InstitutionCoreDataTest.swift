...
class InstitutionCoreDataTest: XCTestCase {

    typealias AppModelClass = Institution
    var entityName: String { return Institution.entityName }
    var sut: AppModelClass { return InstitutionEndpointTest.objectA }
